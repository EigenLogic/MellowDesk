...
小桌伴（MellowDesk）是一款安静待在菜单栏的原生 macOS 桌面伴侣，用一套低打扰的工作间歇计划，轮换提醒你起身活动、日常补水和完成颈肩微运动。
...
请从 [v0.1.0-beta.3 Release](https://github.com/EigenLogic/MellowDesk/releases/tag/v0.1.0-beta.3)
...
当前仓库包含 **60 多个确定性测试**。合成数据自动测试不能替代真实摄像头验收。
...
- [安全政策](SECURITY.md)
- [变更记录](CHANGELOG.md)
- [v0.1.0-beta.3 发布说明](docs/releases/v0.1.0-beta.3.md)
